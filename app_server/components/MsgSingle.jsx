            ...
            if(this.props.message._id == this.props.chosen){
                return(
                    ...
                    <tr key={this.props.index}>
                        ...
                        <td><input id="mgs" value={this.props.message.msg} onChange={this.handleText}/></td>
                        <td><button className = "btn-warning" type="button" value={this.props.id} onClick={this.cancleMsg} >Cancel</button></td>
                        <td><button className="btn-success" type="button" value={this.props.id} onClick={this.saveMsg}>Save</button></td>
                     </tr>
                     );
            }
                ...
                <tr key={this.props.index}>
                    ...
                    <td><button className="btn-info" type="button" value={this.props.id} onClick={this.editMsg}>Edit</button></td>
                </tr>);
            }
        }
